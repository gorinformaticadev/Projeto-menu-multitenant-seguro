            ...
            <CardContent>
              {loading ? (
                ...
                <select
                  ...
                  className="flex h-10 w-full rounded-md border border-skin-border bg-skin-surface px-3 py-2 text-sm ring-offset-skin-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-skin-focus-ring focus-visible:ring-offset-2"
                >
            ...
            {loadingUsers ? (
              ...
              <Card>
                <CardContent className="flex flex-col items-center justify-center py-12">
                  <User className="h-12 w-12 text-skin-text-muted mb-4" />
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              {user.isLocked && (
                                <span className="inline-flex items-center px-2 py-1 rounded-md bg-skin-danger/15 text-skin-danger text-xs font-medium">
                                  <Lock className="h-3 w-3 mr-1" />
                                  BLOQUEADO
                                </span>
                              )}
                              {!user.isLocked && user.loginAttempts > 0 && (
                                <span className="inline-flex items-center px-2 py-1 rounded-md bg-skin-warning/15 text-skin-warning text-xs font-medium">
                            ...
                            {user.isLocked && user.lockedUntil && (
                              <p className="text-xs text-skin-danger mt-1">
                                Bloqueado até: {new Date(user.lockedUntil).toLocaleString("pt-BR")}
                              </p>
                            )}
                          </div>
                        </div>
                        <span className="inline-flex items-center px-2 py-1 rounded-md bg-skin-primary/15 text-skin-primary text-xs font-medium">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="flex h-10 w-full rounded-md border border-skin-border bg-skin-surface px-3 py-2 text-sm ring-offset-skin-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-skin-focus-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                  required
