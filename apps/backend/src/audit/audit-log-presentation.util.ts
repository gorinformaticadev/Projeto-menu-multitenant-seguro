const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  JOB_NOT_RUNNING: "Job atrasado ou parado",
  JOB_REPEATED_FAILURES: "Falhas repetidas em job",
  JOB_STUCK_RUNNING: "Job travado em execucao",
  ...
  OPS_ACCESS_DENIED_SPIKE: "Pico de acessos negados",
  OPS_CRITICAL_SLOW_ROUTE: "Rota critica com latencia alta",
  OPS_DATABASE_DEGRADED: "Banco de dados degradado",
  OPS_HIGH_5XX_ERROR_RATE: "Aumento de erros 5xx",
  OPS_JOB_FAILURE_STORM: "Falhas repetidas em jobs",
  OPS_REDIS_DEGRADED: "Redis degradado",
