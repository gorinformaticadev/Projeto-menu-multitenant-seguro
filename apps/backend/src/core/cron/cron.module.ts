...
@Module({
    ...
    providers: [CronJobHeartbeatService, ExecutionLeaseService, CronService, RedisLockService],
    controllers: [CronController],
    exports: [CronJobHeartbeatService, ExecutionLeaseService, CronService, RedisLockService],
})
