  ...
  private getVerificationEmailTemplate(name: string, verificationUrl: string): string {
    return `
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>VerificaÃ§Ã£o de Email</h1>
          </div>
          <div class="content">
            <p>OlÃ¡ <strong>${name}</strong>,</p>
            <p>Obrigado por se cadastrar no nosso sistema! Para completar seu cadastro, precisamos verificar seu endereÃ§o de email.</p>
            ...
            <p>Se vocÃª nÃ£o se cadastrou no nosso sistema, ignore este email.</p>
          </div>
          <div class="footer">
  ...
  private getTestEmailTemplate(name: string, config: unknown): string {
    return `
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>âœ… ConfiguraÃ§Ã£o de Email Confirmada</h1>
          </div>
          <div class="content">
            <p>OlÃ¡ <strong>${name}</strong>,</p>
            <p>Esta Ã© uma mensagem de teste para confirmar que sua configuraÃ§Ã£o de email estÃ¡ funcionando corretamente.</p>
