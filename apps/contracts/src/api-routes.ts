...
export const SHARED_API_ROUTE_CONTRACT_POLICIES: SharedApiRouteContractPolicy[] = [
  ...
  {
    id: "ops-runtime-test-fair-queue",
    patterns: ["/ops-runtime-test/fair-queue/*"],
    supportedVersions: ["2"],
    request: {
      jsonBytes: 8 * 1024,
  ...
  {
    id: "ops-runtime-test-rate-limit",
    patterns: ["/ops-runtime-test/rate-limit/*"],
    supportedVersions: ["2"],
    request: {
      jsonBytes: 8 * 1024,
      urlencodedBytes: 4 * 1024,
  ...
  },
  {
    id: "ops-runtime-test",
    patterns: [
      "/ops-runtime-test/runtime/*",
      "/ops-runtime-test/dependency/*",
      "/ops-runtime-test/cluster/*",
      "/ops-runtime-test/shedding/*",
      "/ops-runtime-test/alerts/*",
    ],
    supportedVersions: ["2"],
    request: {
      jsonBytes: 16 * 1024,
