...
|---|---|---|
| segurança | `não` | há segredos hardcoded em [docker-compose.dev.yml](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/docker-compose.dev.yml#L26), arquivo de staging versionado em [apps/backend/.env.staging](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/backend/.env.staging#L10) e backup copia env bruto em [backup.service.ts](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/backend/src/backup/backup.service.ts#L1231) |
| consistência | `não` | `REDIS_URL` aparece no env prod, mas o backend usa `REDIS_HOST/PORT/USERNAME/PASSWORD/DB` em [app.module.ts](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/backend/src/app.module.ts#L43) |
...
| Docker | `parcial` | backend está próximo do modelo correto; frontend quebra separação build/runtime com `NEXT_PUBLIC_API_URL` em [apps/frontend/Dockerfile](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/frontend/Dockerfile#L14) |
...
|---|---|---|---|
| `SMTP_PASSWORD` | [secret-manager.service.ts](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/backend/src/common/services/secret-manager.service.ts#L70), [secret-manager.nest.service.ts](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/backend/src/common/services/secret-manager.nest.service.ts#L110) | alto: secret manager carrega um nome que o email service não usa | padronizar tudo para `SMTP_PASSWORD` e adaptar [email.service.ts](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/backend/src/email/email.service.ts#L81) |
| `UPLOADS_DIR`, `BACKUP_DIR` | [paths.service.ts](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/backend/src/core/common/paths/paths.service.ts#L95), [docker-entrypoint.sh](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/backend/docker-entrypoint.sh#L10), [install.sh](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/install/install.sh#L458) | alto em boot manual/native | documentar nos envs oficiais; hoje só Docker/installer injeta |
| `INSTALL_ADMIN_EMAIL`, `INSTALL_ADMIN_PASSWORD` | seeds em `prisma/seeds/defaults.ts`, compose prod, [install.sh](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/install/install.sh#L1147) | alto no primeiro bootstrap | incluir no env de bootstrap, não no runtime permanente |
...
| `REDIS_URL` vs `REDIS_HOST/PORT/USERNAME/PASSWORD/DB` | env prod usa `REDIS_URL`; runtime usa split vars em [app.module.ts](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/backend/src/app.module.ts#L61) | produção pode parecer configurada e mesmo assim subir com Redis errado |
| `SMTP_PASS` vs `SMTP_PASSWORD` | [email.service.ts](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/backend/src/email/email.service.ts#L81) vs secret managers | quebra integração com secret manager |
| `BACKUP_ADMIN_DATABASE_URL` vs `BACKUP_DATABASE_ADMIN_URL` | alias lido em backup config | naming drift aumenta erro operacional |
| frontend usa `NEXT_PUBLIC_API_URL` como build e compose tenta tratá-la como runtime | [apps/frontend/Dockerfile](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/frontend/Dockerfile#L14), [apps/frontend/src/lib/api.ts](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/frontend/src/lib/api.ts#L33), `docker-compose*.yml` | imagem pode ser promovida entre ambientes apontando para API errada |
| carga de env fragmentada | [app.module.ts](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/backend/src/app.module.ts#L43) não fixa `envFilePath`; [backup.service.ts](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/backend/src/backup/backup.service.ts#L1242) e scripts procuram vários arquivos | update/restore/native podem ler arquivos diferentes do backend |
| instalador injeta variáveis não documentadas | [install.sh](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/install/install.sh#L458) | quem sobe manualmente não sabe o contrato real |
...
| backup copia `.env`/`.env.production` para artefato | alto | [backup.service.ts](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/apps/backend/src/backup/backup.service.ts#L1237) faz snapshot do arquivo de env | não incluir env em backup ou criptografar separado com KMS |
| `INSTALL_ADMIN_PASSWORD` default `123456` | alto | [install.sh](D:/Usuarios/Servidor/GORInformatica/Documents/GitHub/Pluggor/install/install.sh#L951) usa senha fraca por padrão | exigir valor explícito ou gerar aleatória |
