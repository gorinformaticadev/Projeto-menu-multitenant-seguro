...
function ModuleMóduloPage() {
  ...
  const render = () => {
    ...
    const title = createElement('h1', { className: 'text-2xl font-bold text-gray-900' }, 'Sistema de Vendas');
    ...
    const steps = [
      '1. Copie a pasta sistema-de-vendas para um novo nome (ex: module-meumodulo)',
